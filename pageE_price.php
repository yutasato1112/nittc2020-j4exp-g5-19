...
<?php
    ...
    $connect = new
    PDO("pgsql:host = $server;dbname = $darabase;port = $port_number;user = $user_id;password = $user_pass");
    $km = 0;
    $MaxA = 100000;
    $MinA = 5000;
    $sql_text = "select * from prod where 価格 between '$MinA' and '$MaxA'　ORDER BY 登録日 DESC";
